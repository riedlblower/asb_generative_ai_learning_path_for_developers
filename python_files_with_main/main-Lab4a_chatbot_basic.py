...
def have_conversation(conversation):
    ...
    print_ww(conversation.predict(input="Give me a five tips on how to stay focused at work."))
    print_ww(conversation.predict(input="Cool. Will that work with finishing work on time?"))
